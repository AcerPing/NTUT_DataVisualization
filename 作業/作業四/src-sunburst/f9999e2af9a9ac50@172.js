...
<h3>從上圖中，我們可以看出：
  <ul>
    <li> 在這份問卷調查中，大部分的回答者來自於工作室內的藝術從業者，佔比最多、佔比近4成，計數199筆；其次是在替代空間工作者。</li>
    <li> 參與這項調查的，有一半以上是來自工作室和替代空間的藝術工作者，佔比約57.3%，計數為294筆。</li>
    <li> 為降低碳足跡，有一成二的藝術工作者選擇實施減少包裝的措施來減少碳排放量；但最多人採取的減少碳排放行動是減少包裝和文宣印刷。</li>
    <li> 在美術館工作的藝術家不僅致力於減少包裝，還努力節約工作場所的能源，但相比其他地點，他們較少選擇使用再生材料作為主要環保措施。</li>
    <li> 在工作室、替代空間、非營利組織／藝術團體工作的工作者中，主要的減碳排行動分別是「減少包裝材及文宣印製」、「使用無毒媒材、再生材料、廢物利用素材等」及「工作場所、活動展場的節約能源」。</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#F596AA","#D0104C","#EB7A77","#734338","#F17C67","#CC543A"])
  .unknown("#62592C")
)}
